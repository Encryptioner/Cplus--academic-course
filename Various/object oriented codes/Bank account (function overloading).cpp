...
void account::display(double y)
{
    int i,n;
    cout<<"Enter the amount below which you want to see accounts:";
    cin>>n;
    printf(" Name        Account No.         Balance\n");
    printf("-----        -----------         --------\n");
    for(i=0; i<c; i++) {
...
int main()
{
    ...
    printf("######## MENU ########\n\n");
        ...
        switch(n) {
            ...
            case 7: lst[count].display(1); break;
            case 8: lst[count].display(1.0);break;
